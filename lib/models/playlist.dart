...
//
//     final playlistM = playlistMFromJson(jsonString);

import 'dart:convert';

PlaylistM playlistMFromJson(String str) => PlaylistM.fromJson(json.decode(str));

String playlistMToJson(PlaylistM data) => json.encode(data.toJson());
